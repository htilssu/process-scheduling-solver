...
const Table = ({solvedProcessesInfo}: TableProps) => {
    ...
    const responseTime = solvedProcessesInfo.map((process) => process.rt);
    ...
    const totalRST = total(responseTime);
    const averageRST = totalRST / numberOfProcesses;
            ...
            <StyledTable>
                ...
                ))}
                {
                    <tr>
                        ...
                        <td>
                            {totalRST} / {numberOfProcesses} = {precisionRound(averageRST, 3)}
                        </td>
                    </tr>
                }
                </tbody>
